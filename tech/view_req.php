...
<section class="bg-secondary text-center p-1">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div style="background-color: darkblue" class="card-header text-white">All Request</div>
                    <div class="card-body">
                        <table class="table">
                            <thead>
                            <tr>
                            ...
                            $sql = "SELECT * FROM requests WHERE tech_id = '{$_SESSION['tech_id']}'  ORDER BY req_id";
