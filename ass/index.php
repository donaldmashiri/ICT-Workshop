...
<section class="bg-secondary text-center p-1">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-10">
                <h2 style="color: navajowhite">Assets Department</h2>
                <div class="card">
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between bg-dark text-white">
                        ...
                        <h6 style="background-color: navajowhite" class="justify-content-end p-2 text-primary">Requests</h6>
                    </div>
                    <div class="card-body">
                        <table class="table">
                        <?php
                        $sql = "SELECT * FROM requests WHERE assets_status = 'pending' OR assets_status = 'rejected'
                                    ORDER BY req_id";
